...
function deriveSwitchTable(project, hasRuleFor) {
  ...
  for (const screen of project.screens || []) {
    for (const obj of collectObjects(screen.objects)) {
      ...
      // Either form of switch: both carry the read and write topics this
      // derives a round trip from. Since 2026-09-20 the form is the type
      // (docs/2026-09-20-control-split.md).
      if (obj.type !== "switch" && obj.type !== "button-group") continue
