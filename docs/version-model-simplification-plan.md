...
landed in `schaltli-firmware` on 2026-08-22: its half of the guard
...
### Firmware (`screenbee-m5dial`, `schaltli-firmware`, e-paper)
...
5. ~~Firmware: rename the guard, change the hello payload.~~ **Done** for
   `schaltli-firmware` (2026-08-22). `SYSTEM_GENERATION_MAJOR/_MINOR`
